...
### Commit 4b: `feat(cloud-runtime): stagehand-compat-smoke.mjs — real Browserbase SDK smoke test` (待做)
...
- [ ] Commit 4b 落地：scripts/stagehand-compat-smoke.mjs（真 Browserbase SDK + Playwright connectOverCDP），需 prod 部署后 5 跑次全绿
