...
`@mosaiq/persona-schema` 包将以 **Apache 2.0 开源**，让全行业受益于这个数据格式标准。
...
| 模块 | 许可 | 理由 |
|---|---|---|
| `@mosaiq/persona-schema` | **Apache 2.0** | 推动行业标准，让 Valibot/ArkType 等生态共用 |
| `@mosaiq/sdk` | **Apache 2.0** | 客户可审查、可二次开发 |
