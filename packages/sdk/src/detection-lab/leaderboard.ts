...
const STYLE = [
  ':root{--fg:#1a1a1a;--muted:#666;--line:#e2e2e2;--hit:#c0392b;--bg:#fff}',
  ...
  '.methodology{color:var(--fg);background:#f7f7f7;border:1px solid var(--line);border-radius:8px;padding:.75rem 1rem}',
  ...
  'table.board th{background:#fafafa;font-weight:600}',
  'table.board td.num,table.board th.num{text-align:right;font-variant-numeric:tabular-nums}',
  'table.board tbody tr:nth-child(odd){background:#fcfcfc}',
  ...
  'code{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.85em;background:#f0f0f0;padding:.05em .35em;border-radius:4px}',
].join('');
